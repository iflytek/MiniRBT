...
def parse(opt=None):
    ...
    parser.add_argument("--ckpt_steps", default=50000, type=int,
                        help="aves the model every ckpt_steps.")
    ...
    parser.add_argument('--load_model_type', type=str,
                        default='bert', choices=['bert', 'all', 'none'])
    ...
    parser.add_argument("--bert_config_file_T", default=None, type=str)
    parser.add_argument("--student_config", default=None, type=str, required=True)
    parser.add_argument("--temperature", default=1, type=float, required=False)
    parser.add_argument("--teacher_cached", action='store_true')
    parser.add_argument("--data_cache_dir", default=None, required=True)
    parser.add_argument("--data_files_json", default=None, required=True)
    parser.add_argument("--teacher_name_or_path", default=None, required=True)
